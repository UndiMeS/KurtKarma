...
public class aXelNumber : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        {
            GameObject.Find("NumbersSolution").GetComponent<SolutionNumbers>().EatenNumberCounter ++;
            Eaten = true;
            
            if(this.gameObject.tag == "aXelNumberLeft")
            {
                ...
                GameObject.Find("Term_Left").GetComponent<TMP_Text>().text += this.gameObject.GetComponent<TMP_Text>().text;
